...
void loop() //This code goes around and around....and around
{
  ...
  //initSDCard(); // Check to see if the SD card is still there.
...
void readLDR()
{
  ...
  if ((darknessLevel > 700) && (flagBL == true) && (flagNL == false))
...
void printLCD()
{
  ...
  flagLCD1 = false;			// Reset LCD screen 1 display flag.
}
